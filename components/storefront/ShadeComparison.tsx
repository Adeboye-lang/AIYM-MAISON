...
function BeforeAfterSlider() {
  ...
  return (
    ...
    >
      {/* After */}
      <Image src="/public/Picture 8.png" alt="8 hours tan result" fill className="object-cover" draggable={false} />
      {/* Before — clipped */}
      <div
        className="shade-clip-panel absolute inset-0 overflow-hidden"
        style={{ "--shade-clip": `${100 - pct}%` } as React.CSSProperties}
      >
        <Image src="/public/Picture 6.jpg" alt="Before tan" fill className="object-cover" draggable={false} />
      </div>
      {/* Labels */}
...
const shades = [
  { label: "4 Hours", src: "/public/Picture 5.png", alt: "4 hour tan result" },
  { label: "Overnight", src: "/public/Picture 9.jpg", alt: "Overnight tan result" },
];
